import type { CollectionFolder, SavedRequest } from '../../../../preload/postman/types';
...
export function flattenFolderOptions(folders: CollectionFolder[], depth = 0, excludeId?: string): FolderOption[] {
