...
export const ImagePreview = forwardRef<PreviewEditorHandle, { filePath: string }>(
  function ImagePreview({ filePath }, ref) {
    const state = useBinaryFilePreview(filePath);

    // Image previews are read-only -- nothing to write back.
