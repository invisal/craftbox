...
interface MutatingWebhooksToolbarProps {
  searchQuery: string;
...
export const MutatingWebhooksToolbar: React.FC<MutatingWebhooksToolbarProps> = ({
  searchQuery,
  caseSensitive,
  useRegex,
  totalCount,
  ...
  return (
    <div className="flex items-center justify-between w-full">
      <KubeSearchbox
        value={searchQuery}
        placeholder="Search Mutating Webhook Configurations..."
